...
You can also use high-win-chance bets and fixed/limited bet sizing to limit your losses. For example, a bet with a 65% win chance is extremely unlikely to incur 11 consecutive losses in a row (source: https://maverickcurrencies.com/odds/). 

So, if you'd only like to lose $220 of your bankroll, you should risk a max of $20 for each bet (since $220 / 11 consecutive losses = $20).
